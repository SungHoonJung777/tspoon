...
<body>
				...
				<div class="boardBox">
					...
					<ul class="boardView">
						...
						<li>
							...
							<span class="title_02"><textarea rows="3" cols="230" name="title">${boardList[0].board_title }</textarea></span>
					   ...
					   <li class="itxtArea">
					   		...
					   		<textarea rows="40" cols="230" name="content" >${boardList[0].board_content}</textarea>
					...
					<ul class="btnList mt_20">
						<li><button class="button dark big" id="cancleBtn">취소</button></li>
	...
	<script type="text/javascript">
		document.querySelector("#cancleBtn").addEventListener("click", function(){
			...
			frm.action = "/milkT/kmocMain.do?command=boardDetail&board_idx=" + idx.value;
			frm.submit();
		...
		document.querySelector("#updateBtn").addEventListener("click", function(){
			...
			frm.action = "/milkT/kmocMain.do?command=updateBoardDetail&board_idx=" + idx.value;
			frm.submit();
