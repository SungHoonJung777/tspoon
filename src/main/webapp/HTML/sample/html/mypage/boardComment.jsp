...
<body>
				...
				<div class="boardBox">
					...
					<ul class="boardView">
					   ...
					   <li class="itxtArea">
						...
						<li><button class="button green big" id="commentBtn">답변등록</button></li>
									 <li class="ansArea">
										<textarea rows="20" cols="223" placeholder="답변 등록" name="comment"></textarea>
	...
	<script type="text/javascript">
		...
		document.querySelector("#commentBtn").addEventListener("click", function(){
			...
			frm.action = "/milkT/kmocMain.do?command=commentBoardRegist&board_idx=" + idx.value;
			frm.submit(); 
