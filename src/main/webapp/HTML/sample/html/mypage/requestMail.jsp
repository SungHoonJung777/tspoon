...
<body>
 ...
 <!--                        <option value="01">김밀코</option>
                ...
                <div class="msgBox">
                    <!--쪽지탭//-->
                    <ul class="msgTab">
                        <li><a href="/milkT/kmocMain.do?command=mail" target="_self">받은 쪽지함</a></li>
                        <li class="on"><a href="/milkT/kmocMain.do?command=requestMail" target="_self">보낸 쪽지함</a></li>
                    </ul>
                    <!--//쪽지탭-->
                    <!--보낸 쪽지 리스트//-->
                    <ul class="msgList">
					...
					<div class="pageInfo_wrap" >
					        <div class="pageInfo_area">
					                ...
					                <c:if test="${pageMaker.prev}">
					                    <li class="pageInfo_btn previous"><a href="/milkT/kmocMain.do?command=requestMail&pageNum=${pageMaker.startPage-1}">Previous</a></li>
					                </c:if>
					 				
					                 <!-- 각 번호 페이지 버튼 -->
					                <c:forEach var="num" begin="${pageMaker.startPage}" end="${pageMaker.endPage}">
					                    <li class="pageInfo_btn ${pageMaker.cri.pageNum == num ? "active":"" }"><a href="/milkT/kmocMain.do?command=requestMail&pageNum=${num}" >${num}</a></li>
									</c:forEach>
					                
					                      <!-- 다음페이지 버튼 -->
					                <c:if test="${pageMaker.next}">
					                    <li class="pageInfo_btn next"><a href="/milkT/kmocMain.do?command=requestMail&pageNum=${pageMaker.endPage + 1 }">Next</a></li>
					                </c:if>  
					        </div>
						</div>
                </div>
